...
$loginError=$logError=$decryp=$cryp=$error=$crypError=$nomError=$emailError=$messageError="";
...
if(isset($_POST['send'])){
    ...
    if(!preg_match('/^[a-z A-Z]+$/',$message) || empty($message)){
        $messageError = "Prenom invalide (alphanumerique)";
        $errors ++;
    }
    // on commence l'envoy
    if($error == 0){
        ...
        $texte = "<font color=\"red\">".$message."</font>";
        $destinataire= $admin['email'];
        $delapartde = $email;
        $from  = "From:".$delapartde."".$passage_ligne;
        $from .= "MIME-version: 1.0".$passage_ligne;
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <section id="contact" class="content-section text-center">
                        <div class="contact-section">
                            <div class="container">
                                <h2>Envoyer moi un message en precisant une note merci pour ce tp</h2>
                                    ...
                                    <div class="col-md-8 col-md-offset-2">
                                        <form class="form-horizontal" action="" method="post">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="tName" name="nom" placeholder="Jane Doe">
                                                <span class="help-inline"><?php echo $nomError; ?></span>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail2">Email</label>
                                                <input type="email" name="email" class="form-control" id="exampleInputEmail2" placeholder="loic@example.com">
